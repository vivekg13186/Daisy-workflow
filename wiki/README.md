...
A YAML-driven DAG workflow engine with pluggable actions, parallel execution, retries, batch fan-out, a graphical editor, and an AI assistant.
...
3. [DSL reference](./03-dsl-reference.md) — full YAML syntax, expressions, runtime context, and execution semantics.
